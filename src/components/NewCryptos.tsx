  ...
  return (
    <section className="relative py-12 px-6 text-white">
      ...
      <div className="relative max-w-7xl mx-auto z-10">
        ...
        <button className="bg-accent text-white px-6 py-3 font-semibold rounded-lg shadow-lg hover:bg-yellow-500 hover:shadow-xl hover:scale-105 hover:animate-pulse transition-all duration-300 transform">            Ver todas las criptos nuevas
          </button>
        </div>
